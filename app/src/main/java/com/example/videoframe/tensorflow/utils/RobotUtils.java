...
public class RobotUtils {
     ...
     */
    public static Holder freezeRobot(QiContext qiContext, QiChatbot chatbot, Chat chat) {
    ...
    public static Future<Void> cancelFuture(Future<?> futureToCancel) {
    ...
    public static Future<Void> cancelAllFutures(Future<?>... futuresToCancel) {
